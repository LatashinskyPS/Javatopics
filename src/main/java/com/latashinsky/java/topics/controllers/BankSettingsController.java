...
public class BankSettingsController extends BaseSettingsController<Bank> {
    ...
    public void show(Bank bank) {
        ...
        AccountRepository<Account> accountRepository = (AccountRepository<Account>) myRepository;
        List<Account> list = (List<Account>) accountRepository.getAccountsBank(bank);
