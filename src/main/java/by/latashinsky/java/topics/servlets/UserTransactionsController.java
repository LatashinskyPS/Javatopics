...
public class UserTransactionsController {
    private final MyRepository<User> userMyRepository = (MyRepository<User>) Factory.getInstance().getRepository(User.class);
    private final MyRepository<Transaction> transactionMyRepository = (MyRepository<Transaction>) Factory.getInstance().getRepository(Transaction.class);
